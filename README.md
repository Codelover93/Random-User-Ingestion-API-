...
Schedule::command('app:fetch-add-random-users')
    ->everyFiveMinutes();
Local Development
...
All inserts wrapped inside:

DB::transaction()

Guarantees:

All tables insert successfully
...
Password hashing via Laravel casting
...
Pagination instead of manual limit
